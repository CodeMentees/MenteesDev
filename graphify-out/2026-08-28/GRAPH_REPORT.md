...
## Corpus Check
- 219 files · ~438,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 855 nodes · 1471 edges · 115 communities (53 shown, 62 thin omitted)
...
Cohesion: 0.14
Nodes (13): isAdmin(), Home, homeSchema, authRouter, router, router, upload, router (+5 more)
...
- **Why does `isAdmin()` connect `routes/index.js` to `authController.js`, `schoolCodingLeadRoutes.js`, `schoolCourseRoutes.js`, `postRoutes.js`, `queryRoutes.js`, `courseRoutes.js`, `blogCategoryRoutes.js`, `categoryRoutes.js`, `eventRoutes.js`, `jobRoutes.js`, `liveCourseRoutes.js`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
