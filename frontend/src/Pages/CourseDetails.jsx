...
import tabs from "../JSON/courseDetails.json"
...
function CourseDetails() {
    ...
    console.log("deatils is ", details)
                ...
                <div className=" grid grid-cols-2 lg:grid-cols-6 ">
                    <div className="max-w-3xl pl-8 col-span-4 h-80 mx-auto relative  py-8 my-8 dark:bg-blue-700">
                        ...
                        <div className="absolute h-12 py-8  -bottom-6 container max-w-screen-sm ml-4  bg-white-700 dark:bg-gray-700">
                            <div class="grid grid-cols-1 bottom-1 absolute   md:grid-cols-4 gap-3 text-center">
                                <div class="text-center">
                                    <div class="text-sm  text-white-600 dark:text-white">
                                        350+
                                    </div>
                                    <div class="text-gray-600 text-xs text-white-600 dark:text-white">
                                        problems
                                    </div>
                                </div>

                                <div class="text-center">
                                    <div class="text-sm  text-white-600 dark:text-white">6</div>
                                    <div class="text-white-600 text-xs dark:text-white">
                                        Live projects
                                    </div>
                                </div>

                                <div class="text-center">
                                    <div class="text-sm text-white-600 dark:text-white">4/6</div>
                                    <div class="text-white-600 text-xs dark:text-white">
                                        Duration
                                    </div>
                                </div>
