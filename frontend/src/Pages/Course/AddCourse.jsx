...
function AddCourse() {
  const { courseId } = useParams(); // Get course ID from URL (if editing)
      ...
      {toast.visible && (
        <div
          className={`fixed top-5 right-5 p-4 text-sm font-medium rounded-lg shadow-md ${
            toast.type === "error"
              ? "text-red-400 bg-gray-800 border border-red-500"
      ...
      <div className="py-2 px-4 mx-auto max-w-2xl lg:py-16">
        ...
        <form>
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-dark-btn text-black font-semibold rounded-lg hover:bg-yellow-400 transition"
          >
