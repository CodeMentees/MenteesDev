...
function SummerInternshipModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-gray-900 border border-gray-700 rounded-3xl shadow-2xl shadow-purple-900/50 w-full max-w-2xl overflow-hidden transform transition-all animate-float">
